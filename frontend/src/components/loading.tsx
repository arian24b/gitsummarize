...
const messages = [
  ...
  "Reasoning about the documentation...",
  ...
  "I'm tired...",
  "Please just give me the documentation...",
  "...NOW!",
  "guess not...",
];
  ...
  return (
    <span className="inline-flex w-8 justify-start">
      <span className="flex gap-0.5">
        <span className="h-1 w-1 animate-[dot1_1.5s_steps(1)_infinite] rounded-full bg-green-500" />
        <span className="h-1 w-1 animate-[dot2_1.5s_steps(1)_infinite] rounded-full bg-green-500" />
        <span className="h-1 w-1 animate-[dot3_1.5s_steps(1)_infinite] rounded-full bg-green-500" />
      </span>
    </span>
  );
};
      ...
      {[1, 2, 3].map((step) => (
        <div
          ...
          className={`h-1.5 w-1.5 rounded-full transition-colors duration-300 ${
            step <= currentStep ? "bg-green-500" : "bg-green-200"
          }`}
        />
      ))}
    </div>
...
export default function Loading({
  ...
  const renderReasoningMessage = () => {
    ...
    switch (reasoningType) {
      ...
      case "diagram":
        return "Model is planning the documentation structure and content...";
      default:
        return null;
    }
  };
  ...
  const getStatusDisplay = () => {
    ...
    switch (status) {
      ...
      case "diagram_chunk":
        return {
          text: reasoningType
            ? "Model is reasoning about documentation structure"
            : "Generating documentation...",
          isReasoning: !!reasoningType,
        };
      default:
  ...
  return (
    <div className="mx-auto w-full max-w-4xl p-4">
      <div className="overflow-hidden rounded-xl border-2 border-green-200 bg-green-50/30 backdrop-blur-sm">
        <div className="border-b border-green-100 bg-green-100/50 px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 text-xs font-medium text-green-500">
        ...
        <div ref={scrollRef} className="max-h-[400px] overflow-y-auto p-6">
          <div className="flex flex-col gap-6">
            ...
            {reasoningMessage &&
              ...
              (explanation ?? mapping ?? diagram) && (
                <div className="rounded-lg bg-green-100/50 p-4 text-sm text-green-500">
                  <div className="flex items-center gap-2">
            ...
            {explanation && (
              <div className="rounded-lg bg-white/50 p-4 text-sm text-gray-600">
                <p className="font-medium text-green-500">Explanation:</p>
                <p className="mt-2 leading-relaxed">{explanation}</p>
              </div>
            )}
            {mapping && (
              <div className="rounded-lg bg-white/50 p-4 text-sm text-gray-600">
                <p className="font-medium text-green-500">Mapping:</p>
